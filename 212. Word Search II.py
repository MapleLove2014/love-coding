class Node:
    def __init__(self, isWord=False, ref=-1):
        self.nodes = [None]*26
        self.isWord = isWord
        self.ref = ref
class Trie:
...
class Solution:
    def findWords(self, board, words):
        def find(t, i, j):
            idxch = ord(board[i][j]) - ord('a')
            if not t.nodes[idxch]:
                return []
            tmp = board[i][j]
            board[i][j] = '#'
            node = t.nodes[idxch]
            result = []
            if node.isWord:
                result += [words[node.ref]]
                node.isWord = False
            for ij in [ [0, 1], [0, -1], [1, 0], [-1, 0] ]:
                id = ij[0] + i
                jd = ij[1] + j
                if id < 0 or id >= m or jd < 0 or jd >= n or board[id][jd] == '#':
                    continue
                result += find(node, id, jd)
            board[i][j] = tmp
            return result
...
print(s.findWords([["b","a","b","a","b","a","b","a","b","a"],["a","b","a","b","a","b","a","b","a","b"],["b","a","b","a","b","a","b","a","b","a"],["a","b","a","b","a","b","a","b","a","b"],["b","a","b","a","b","a","b","a","b","a"],["a","b","a","b","a","b","a","b","a","b"],["b","a","b","a","b","a","b","a","b","a"],["a","b","a","b","a","b","a","b","a","b"],["b","a","b","a","b","a","b","a","b","a"],["a","b","a","b","a","b","a","b","a","b"]], 
